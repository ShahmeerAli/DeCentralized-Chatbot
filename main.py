...
async def humanoid_reviewer(state:AgentState):
    """Review the answer from Human point of view."""

    result=await llm.ainvoke(
         state['messages'] + [SystemMessage(content="You replicate human professionalism and you review the answer generated by the A.I."
         "You find loopholes in the answer and suggest the new answer.")]
    )
    return {
...
graph.add_node('humanoid',humanoid_reviewer)
...
graph.add_edge('critique','humanoid')
graph.add_edge("humanoid","final_answer")
